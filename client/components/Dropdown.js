    ...
    <div className="relative">
      <div >
        <button
          ...
          type="button" 
          className="w-full inline-flex justify-start rounded-md bg-white px-3 py-2 items-center text-xs lg:text-sm font-semibold text-gray-800 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
